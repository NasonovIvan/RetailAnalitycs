...
*part1.sql* script was written that creates the database and tables described above in the [Input data](#input-data).

Also, procedures were added to the script that allow you to import and export data for each table from/to a file with *.csv* and *.tsv* extensions. \
